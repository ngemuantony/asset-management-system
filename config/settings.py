...
# Add Swagger in debug mode only
if DEBUG:
...
MIDDLEWARE = [
    ...
    'apps.requests.middleware.RequestMiddleware',  # Our custom middleware
]
...
# Add any request-specific settings
REQUEST_ATTACHMENT_TYPES = ['application/pdf', 'image/jpeg', 'image/png']
MAX_REQUEST_ATTACHMENT_SIZE = 5 * 1024 * 1024  # 5MB
